...
products = []
for i in range(1, 4):
    print(f"Введите информацию о  {i}-м товаре")
    ...
    products.append((i, {'название': product_name, 'цена': product_price, 'количество': product_count,
    'eд': product_measure}))
...
print(f"Отчет по списку товаров: {report}")